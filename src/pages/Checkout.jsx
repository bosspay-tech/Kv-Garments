            ...
            <div className="overflow-hidden rounded-2xl border border-violet-200 bg-white shadow-sm">
              ...
              <div className="px-5 py-4">
                  ...
                  {items.map((item, i) => {
                    ...
                    return (
                      <div
                        ...
                        className="flex items-start justify-between gap-4 rounded-xl border border-violet-200 bg-white p-3"
                      >
                ...
                <div className="mt-5 rounded-xl border border-violet-200 bg-violet-50 p-4">
                  ...
                  <div className="mt-2 flex items-center justify-between text-sm text-violet-700">
                    <span>Shipping</span>
                    <span className="text-violet-500">Calculated later</span>
                  </div>
              ...
              <button
                ...
                className={[
                  ...
                  loading
                    ...
                    : "bg-violet-950 text-white hover:bg-violet-900 focus:ring-violet-200",
                ].join(" ")}
              >
                {loading
                  ? "Placing order..."
